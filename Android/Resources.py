...
class Pointers(object):
    ...
    def __init__(self):
        ...
        resourcepath, directories, files = os.walk(basepath).next()
        self.resmap = resmap = {}
...
class Resources(object):
    ...
    def getDrawable(self, id, theme=None):
        ...
        try:
            ...
            if isinstance(drawablefile, basestring):
