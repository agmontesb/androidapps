...
#
# ported from:
# https://android.googlesource.com/platform/frameworks/base/+/1ab598f/tools/aapt2/SdkConstants.h
# https://android.googlesource.com/platform/frameworks/base/+/1ab598f/tools/aapt2/SdkConstants.cpp
#
import itertools

from Tools.aapt.Resource import ResourceType, ResourceId
...
def findAttributeSdkLevel(arg):
    if hasattr(arg, 'entryId'):
        id = arg    # ResourceId
        if id.packageId() != 0x01 and id.typeId() != 0x01:
            return 0
        return sAttrMap.get(id.entryId(), SDK_LOLLIPOP_MR1)
    else:
        name = arg  # ResourceName
        if name.package != u"android" and name.type != ResourceType.kAttr:
            return 0
        return sAttrMap.get(name.entry, SDK_LOLLIPOP_MR1)
